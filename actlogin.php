...
$email = $_POST['email'];
$pass = $_POST['password'];
$q_log_cus = mysqli_query($db,"SELECT * from customer where email_cus = '$email' && password_cus='$pass'");
$q_log_su = mysqli_query($db,"SELECT * from superuser where email_su = '$email' && password_su = '$pass'");
