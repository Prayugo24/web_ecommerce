...
<div class="form-group">
    ...
    <select class="form-control" name="provinsi">
        ...
        session_start();
        $tanggal = date('Y-m-d');
    	$qryprov = mysqli_query($db,"SELECT * from provinsi");
    	while($dataprov = mysqli_fetch_array($qryprov)){
    	?>
    	<option value="<?php echo $dataprov['provinsi']; ?>"><?php echo $dataprov['provinsi']; ?></option>
    	<?php } ?>
    </select>
    <div id="b"></div>
</div>
...
<input type="submit" name="lanjutkan" value="Lanjutkan Pembayaran" class="btn btn-info">
</form>
