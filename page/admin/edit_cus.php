...
include"../../db.php";
$id = $_GET['id'];
$e_qry_cus = mysqli_query($db,"SELECT * from customer where id_cus='$id'");
...
if($simpan)
{
	...
	$kd = $_POST['id_cus'];
	mysqli_query($db,"UPDATE customer set nama_cus='$cos',email_cus='$ecos',password_cus='$pcos' where id_cus='$kd'");
