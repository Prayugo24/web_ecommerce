...
$no =1;
  ...
  <tr>
      ...
      <td><center><?php $qrystok = mysqli_query($db,"SELECT * from stok where id_buku='$data[id_buku]'");$data_stok=mysqli_fetch_array($qrystok);
      $stok=$data_stok['stok']; echo $stok;if($stok==""){ ?>
          ...
          <form action="tambah_buku.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="katalog">
                        <?php
                            $q_allkatalog = mysqli_query($db,"SELECT * from katalog");
